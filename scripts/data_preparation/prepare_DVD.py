...
if __name__ == '__main__':
    ...
    dataset_path = '/home/jq/Trans/VSR-Transformer-main/data/DVD'

    # rearrange_dir_structure(dataset_path)
    generate_meta_info_txt(dataset_path, '/home/jq/Trans/VRT/basicsr/data/meta_info/meta_info_DVD_GT.txt')
