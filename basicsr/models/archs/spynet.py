...
from basicsr.models.common import (PixelShufflePack, ResidualBlockNoBN, flow_warp, make_layer)
# from basicsr.models.registry import BACKBONES
...
class SPyNet(nn.Module):
    ...
    def compute_flow(self, ref, supp):
        ...
        flow = ref[0].new_zeros(n, 2, torch.div(h, 32, rounding_mode='trunc'), torch.div(w, 32, rounding_mode='trunc'))
