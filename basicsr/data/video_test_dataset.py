...
class VideoTestDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if opt['name'].lower() in ['vid4', 'reds4', 'redsofficial','udm10','dvd']:
...
class VideoREDSTestDataset(data.Dataset):
    """Video test dataset.
...
class VideoDenoising_DeblurringTestDataset(data.Dataset):
    """Video test dataset for recurrent architectures, which takes LR video
    ...
    def __init__(self, opt):
        super(VideoDenoising_DeblurringTestDataset, self).__init__()
        self.opt = opt
        self.cache_data = opt['cache_data']
        self.gt_root, self.lq_root = opt['dataroot_gt'], opt['dataroot_lq']
        self.data_info = {'lq_path': [], 'gt_path': [], 'folder': [], 'idx': [], 'border': []}
